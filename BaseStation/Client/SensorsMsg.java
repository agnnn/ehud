 ...
 * This class implements a Java interface to the 'SensorsMsg'
 * message type.
 */

public class SensorsMsg extends net.tinyos.message.Message {
    ...
    /** Create a new SensorsMsg of size 10. */
    public SensorsMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new SensorsMsg of the given data_length. */
    public SensorsMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new SensorsMsg with the given data_length
     * and base offset.
     */
    public SensorsMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new SensorsMsg using the given byte array
     * as backing store.
     */
    public SensorsMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public SensorsMsg(byte[] data, int base_offset) {
     ...
     */
    public SensorsMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new SensorsMsg embedded in the given message
     * at the given base offset.
     */
    public SensorsMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public SensorsMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
